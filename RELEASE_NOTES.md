...
This update keeps `cloudflare-gateway-pihole-scripts` aligned with the English-facing engineering portfolio while removing dash-line motion from SVG visuals.
